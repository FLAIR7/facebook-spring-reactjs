    ...
    return (
        <div id="banner">
            <div className="navbar">
                <div className="navbar__leftside--corner">
                    <div className="navbar__leftside--corner2">
                        <i></i>
                        <div></div>
                    </div>
                </div>
                <a className="navbar__logo--link" href="/home">
                                    ...
                                    <span>
                                        <div className="item__container">
                                            ...
                                            <a className="icon__container">
                                                <span className="icon icon__blue">
            ...
            <div className="navbar__rightside">
                <div className="rightside__sector">
                    <span className="rightside__profile">
                        <div className="rightside__profile--caption">
                            <div className="rightside__profile--container">
                                <div className="rightside__profile--pic">
                                    <svg aria-label="Seu perfil" className="x3ajldb" data-visualcompletion="ignore-dynamic" role="img" style={{height: "40px", width: "40px"}}>
                                        <mask id="jsc_c_p">
                                            <circle cx="20" cy="20" fill="white" r="20"></circle>
                                        </mask>
                                        <g mask="url(#jsc_c_p)">
                                            <image style={{height: "40px", width: "40px"}} x="0" y="0" height="100%" preserveAspectRatio="xMidYMid slice" width="100%" xlinkHref="https://scontent-gru1-2.xx.fbcdn.net/v/t1.30497-1/143086968_2856368904622192_1959732218791162458_n.png?stp=cp0_dst-png_p40x40&amp;_nc_cat=1&amp;ccb=1-7&amp;_nc_sid=7206a8&amp;_nc_ohc=Iey42NUlTi8AX8sUHcr&amp;tn=JoQ-q5seIAbsHzuE&amp;_nc_ht=scontent-gru1-2.xx&amp;oh=00_AT-m4JtQFG12ZgV6CVfVYixpUXwNspeXhW4ZnpWoOuEXXw&amp;oe=6364B778"></image>
                    ...
                    <div className="rightside__notification">
                        <span className="rightside__profile">
                            <span>
                                <div className="rightside__notification--caption">
                                    <a>
